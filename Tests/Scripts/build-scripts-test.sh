...
windows_script="$root/scripts/build-windows.ps1"
require_file "$windows_script"
require_file "$root/windows/CodexQuota.Windows/CodexQuota.Windows.csproj"
require_file "$root/windows/CodexQuota.Windows.Tests/CodexQuota.Windows.Tests.csproj"
require_text "$windows_script" "dotnet publish"
require_text "$windows_script" "@('x64', 'arm64')"
require_text "$windows_script" "--self-contained true"
require_text "$windows_script" "Compress-Archive"
require_text "$windows_script" "Get-FileHash -Algorithm SHA256"
require_text "$root/windows/CodexQuota.Windows/CodexQuota.Windows.csproj" "net8.0-windows10.0.19041.0"
require_text "$root/windows/CodexQuota.Windows/CodexQuota.Windows.csproj" "<UseWPF>true</UseWPF>"
